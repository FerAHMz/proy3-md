...
MATCH (p:Pieza {id: 'RC001-P02-03'}) SET p.presente = false;
...
// MATCH (p:Pieza) WHERE p.id IN ['RC001-P01-01', 'RC001-P04-06'] SET p.presente = false;
...
// MATCH (p:Pieza) WHERE p.id IN ['RC004-P02-01','RC004-P02-02','RC004-P02-03','RC004-P02-04','RC004-P02-05','RC004-P02-06'] SET p.presente = false;
